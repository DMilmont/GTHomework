...
#Question 4
use logistic regression to find a good predictive model for whether credit applicants are good credit risks ornot. Show your model (factors used and their coefficients), the software output, and the quality of fit. 

```{r}
#v21 is the response variable, it is supposed to be logical. Converting to 0 and 1 rather than 1 and 2
